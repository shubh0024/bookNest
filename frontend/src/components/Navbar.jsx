...
function Navbar() {
  ...
  return (
    ...
    ${sticky?
       "sticky-navbar  shadow-md bg-base-900 duration-300 transition-all ease-in-out"
      :""}`}>
  ...
  <div className="navbar-center hidden lg:flex">
    ...
    <label className="input input-bordered flex items-center mx-4 gap-2">
  ...
  {/* sun icon */}
  <svg
    className="swap-off h-8 w-8 fill-current mx-4"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
  ...
  {/* moon icon */}
  <svg
    className="swap-on h-8 w-8 fill-current mx-4"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
